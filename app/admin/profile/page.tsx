...
export default function AdminProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      {/* Profile Form */}
      <form onSubmit={handleProfileUpdate} className="mb-10 rounded-lg border border-border p-6">
      ...
      {/* Password Form */}
      <form onSubmit={handlePasswordChange} className="rounded-lg border border-border p-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          {pwMessage && (
            <div className="flex items-center gap-2 rounded-md bg-green-50 px-3 py-2 text-sm text-green-700">
              <Check className="h-4 w-4" /> {pwMessage}
            </div>
          )}
          {pwError && (
            <div className="flex items-center gap-2 rounded-md bg-red-50 px-3 py-2 text-sm text-red-700">
          ...
          <Button type="submit" disabled={pwLoading} variant="secondary" className="self-start">
