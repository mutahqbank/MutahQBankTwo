...
export async function PUT(
  ...
  try {
    ...
    if (custom_name !== undefined) { fields.push(`custom_name = $${idx++}`); values.push(custom_name || null) }
    if (design_level !== undefined) { fields.push(`design_level = $${idx++}`); values.push(design_level || 'normal') }
