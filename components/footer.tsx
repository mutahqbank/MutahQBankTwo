          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <a href="mailto:support@questionosis.com" className="flex items-center gap-2 text-sm text-primary-foreground/70 transition-colors hover:text-primary-foreground">
                  <Mail className="h-3.5 w-3.5" />
                  support@questionosis.com
                </a>
              </div>
            </div>
          </div>
